...
TOKEN = '7208509214:AAH8KUOgyvv3siMhqhd21sGxUBDZdxIKBBA'
...
FORWARD_CHANNEL_ID = -4236705146
CHANNEL_ID = -4236705146
error_channel_id = -4236705146
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*contact admin*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@jatt_agya*", parse_mode='Markdown')
    else:
